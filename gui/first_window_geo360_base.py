...
class Ui_main(object):
    def setupUi(self, main):
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 0, 561, 174))
        ...
        self.lbl_email_3 = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.gridLayout.addWidget(self.lbl_email_3, 0, 2, 1, 1)
        self.label_4 = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        self.label_4.setAlignment(QtCore.Qt.AlignCenter)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 0, 1, 1, 1)
        self.lbl_copyrights_2 = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.lbl_copyrights_2.setFont(font)
        self.lbl_copyrights_2.setTextFormat(QtCore.Qt.RichText)
        self.lbl_copyrights_2.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.gridLayout.addWidget(self.lbl_copyrights_2, 1, 1, 1, 1)
        self.lbl_email_2 = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.lbl_email_2.setFont(font)
        self.lbl_email_2.setTextFormat(QtCore.Qt.RichText)
        self.lbl_email_2.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_email_2.setOpenExternalLinks(True)
        self.lbl_email_2.setTextInteractionFlags(QtCore.Qt.TextBrowserInteraction)
        self.lbl_email_2.setObjectName("lbl_email_2")
        self.gridLayout.addWidget(self.lbl_email_2, 1, 2, 1, 1)
        ...
        self.label_8.setPixmap(QtGui.QPixmap("../images/logo_enviro.png"))
    ...
    def retranslateUi(self, main):
        ...
        self.label_10.setText(_translate("main", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">  &nbsp;&nbsp;Wtyczka PhotoViewer360</span></p></body></html>"))
        self.lbl_email_3.setText(_translate("main", "<html><head/><body><p><a href=\"http://klasterpro.pl/\"><span style=\" text-decoration: underline; color:#0000ff;\">KLASTER PRO</span></a></p></body></html>"))
        self.label_4.setText(_translate("main", "właściciel: Klaster Pro (Robert Milczarek)"))
        self.lbl_copyrights_2.setText(_translate("main", "<html><head/><body><p>autor: <a href=\"http://www.envirosolutions.pl/\"><span style=\" text-decoration: underline; color:#0000ff;\">EnviroSolutions Sp. z o.o.</span></a></p></body></html>"))
        self.lbl_email_2.setText(_translate("main", "<html><head/><body><p><a href=\"https://www.envirosolutions.pl/images/Narz%C4%99dzia%20Automatyzacji%20QGIS.pdf\"><span style=\" text-decoration: underline; color:#0000ff;\">ZAPRASZAMY DO WSPÓŁPRACY</span></a></p></body></html>"))
