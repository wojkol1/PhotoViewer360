...
class Ui_main(object):
    def setupUi(self, main):
        ...
        self.lbl_copyrights_2 = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.lbl_email_3 = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 371, 21))
        ...
        self.lbl_copyrights_3 = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
    ...
    def retranslateUi(self, main):
        ...
        self.lbl_email_3.setText(_translate("main", "<html><head/><body><p><a href=\"http://klasterpro.pl/\"><span style=\" text-decoration: underline; color:#0000ff;\">KLASTER Robert M.</span></a></p></body></html>"))
